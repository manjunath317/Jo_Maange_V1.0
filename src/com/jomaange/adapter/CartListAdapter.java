...
public class CartListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        entity_details_item_qty_add = (LinearLayout) convertView.findViewById(R.id.entity_details_item_qty_add);
        entity_details_item_qty_less = (LinearLayout) convertView.findViewById(R.id.entity_details_item_qty_less);
